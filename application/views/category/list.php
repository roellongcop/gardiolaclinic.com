...
<!-- page content -->
<div class="right_col" role="main" id="categoryPage"> 
	...
	<div class="row">
		<div class="col-md-12 col-sm-12 col-xs-12">
			...
			<update-form v-if="updateForm" :categories="selected" @cancel="cancel" @save="save"></update-form>
			<delete-form v-if="deleteForm" :categories="selected" @cancel="cancel" @save="save"></delete-form>
			<print-form v-if="printForm" :categories="selected" @cancel="cancel"></print-form>
		</div> 
	</div> 
</div> 
<?= $footer ?> 
