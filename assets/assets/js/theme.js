...
(function ($) {
	...
	*/
    ...
    $('#blue').on('click', function(){
		$("head link[rel='stylesheet']").last().after("<link rel='stylesheet' href='" + base_url + "assets/assets/css/theme.css' type='text/css' media='screen'>");
        $('.color-sw-item').removeClass('active');
        $(this).addClass('active');
        document.cookie = "color=blue";
	})
    $('#violet').on('click', function(){
		$("head link[rel='stylesheet']").last().after("<link rel='stylesheet' href='"+ base_url + "assets/assets/css/theme_violet.css' type='text/css' media='screen'>");
        $('.color-sw-item').removeClass('active');
        $(this).addClass('active');
        document.cookie = "color=violet";
	})
    $('#red').on('click', function(){
		$("head link[rel='stylesheet']").last().after("<link rel='stylesheet' href='"+ base_url + "assets/assets/css/theme_red.css' type='text/css' media='screen'>");
        $('.color-sw-item').removeClass('active');
        $(this).addClass('active');
        document.cookie = "color=red";
	})
    $('#green').on('click', function(){
		$("head link[rel='stylesheet']").last().after("<link rel='stylesheet' href='"+ base_url + "assets/assets/css/theme_green.css' type='text/css' media='screen'>");
        $('.color-sw-item').removeClass('active');
        $(this).addClass('active');
