...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 21, 2018 at 05:04 AM
...
(1, 'basic', '{"name":"Gardiola Clinic Management System","address":"sunshine blk 1","number":"09087823231","facebook":"gardiola","gmail":"gardiola@gmail.com","twitter":"gardiola@twitter","skype":"gardiola@sype","yahoo":"gardiola@yahoo.","description":"Open the Application Preferences\\nSelect \\u201cText Encodings\\u201d on the left.\\nIn \\u201cDefault text encoding for new documents\\u201d, select \\u201cUnicode (UTF-8, no BOM)\\u201d\\nOptional: In \\u201cIf file\\u2019s encoding can\\u2019t be guessed, use\\u201d, select \\u201cUnicode (UTF-8, no BOM)\\u201d\\nSelect \\u201cText Files\\u201d on the left.\\nIn \\u201cDefault line breaks\\u201d, select \\u201cMac OS X and Unix (LF)\\u201d","terms":"The PHP closing tag on a PHP document ?> is optional to the PHP parser. However, if used, any whitespace following the closing tag, whether introduced by the developer, user, or an FTP application, can cause unwanted output, PHP errors, or if the latter are suppressed, blank pages. For this reason, all PHP files MUST OMIT the PHP closing tag and end with a single empty line instead."}', 0);
...
(10001, 'Roel', 'R', 'Longcop', 'San Jose GMA', 'longcoproel@gmail.com', 'aide', '09088267471', 'Male', 'dentalaide', 1, 0, 3509, 'aide', 0),
...
(1, 'Shoe', 2000.00, 100, 10, 20, 'Safe', 2, 1, 3, 1),
(2, 'Watch', 200.00, 200, 20, 2, 'Critical', 1, 3, 3, 0),
(3, 'Shoe box', 1212.00, 12, 22323, 1, 'Critical', 2, 3, 5, 1),
(4, 'Raise band', 23.00, 2323, 23, 0, 'Empty', 1, 2, 4, 0);
...
INSERT INTO `tbl_opening` (`id`, `day`, `open`, `close`, `is_deleted`) VALUES
(1, 'Sunday', 'CLOSED', 'CLOSED', 0),
(2, 'Tuesday', '09:00 AM', '08:00 AM', 1),
(3, 'Thursday', '05:00 PM', '07:00 PM', 1),
(4, 'Wednesday', 'CLOSED', 'CLOSED', 1);
...
(1, 'Package 1 For Cleaning', 2, '[{"id":"4","name":"2323","unit_name":"Unit","qty":"2"}]', 0),
(2, 'Package 2 For Check Up', 1, '[{"id":"2","name":"Watch","unit_name":"Pieces","qty":"2"},{"id":"1","name":"Shoe","unit_name":"Pieces","qty":"1"}]', 0);
