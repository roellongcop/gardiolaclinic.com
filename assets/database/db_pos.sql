...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 28, 2018 at 06:59 AM
...
(1, 'Shoes', 123.00, 12322, 2, 13, 'Safe', 2, 1, 1, 0);
...
--
-- Table structure for table `tbl_teeth_status`
--

CREATE TABLE `tbl_teeth_status` (
  `id` int(10) NOT NULL,
  `name` varchar(200) NOT NULL,
  `is_deleted` int(1) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
--
-- Indexes for table `tbl_teeth_status`
--
ALTER TABLE `tbl_teeth_status`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `tbl_teeth_status`
--
ALTER TABLE `tbl_teeth_status`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT;
--
